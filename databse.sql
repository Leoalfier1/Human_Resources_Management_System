...
CREATE TABLE IF NOT EXISTS `vacancies` (
  ...
  `position_type` enum('teaching','non_teaching') DEFAULT 'teaching',
...
-- ─── MIGRATION: Add columns for teaching/non-teaching support ─────────────
ALTER TABLE `users`
    ADD COLUMN IF NOT EXISTS `applicant_type` VARCHAR(50) DEFAULT NULL
    AFTER `role`;

ALTER TABLE `vacancies`
    ADD COLUMN IF NOT EXISTS `position_type` ENUM('teaching','non_teaching') DEFAULT 'teaching'
    AFTER `division_memo_file_path`;

-- ─── MIGRATION: Create personal_data_sheets table if not exists ────────────
CREATE TABLE IF NOT EXISTS `personal_data_sheets` (
  ...
  `dual_citizenship_type` varchar(50) DEFAULT NULL,
  `res_house_block_lot` varchar(100) DEFAULT NULL,
  `res_street` varchar(100) DEFAULT NULL,
  `res_subdivision_village` varchar(100) DEFAULT NULL,
  ...
  `perm_same_as_residential` tinyint(1) DEFAULT '1',
  `perm_house_block_lot` varchar(100) DEFAULT NULL,
  `perm_street` varchar(100) DEFAULT NULL,
  `perm_subdivision_village` varchar(100) DEFAULT NULL,
  ...
  `spouse_employer_business_name` varchar(255) DEFAULT NULL,
  ...
  `q34a_answer` varchar(10) DEFAULT NULL,
  `q34a_details` text,
  `q34b_answer` varchar(10) DEFAULT NULL,
  `q34b_details` text,
  `q35a_answer` varchar(10) DEFAULT NULL,
  `q35a_details` text,
  `q35b_answer` varchar(10) DEFAULT NULL,
  `q35b_details` text,
  `q35b_date_filed` date DEFAULT NULL,
  `q35b_case_status` varchar(100) DEFAULT NULL,
  `q36_answer` varchar(10) DEFAULT NULL,
  `q36_details` text,
  `q37_answer` varchar(10) DEFAULT NULL,
  `q37_details` text,
  `q38a_answer` varchar(10) DEFAULT NULL,
  `q38a_details` text,
  `q38b_answer` varchar(10) DEFAULT NULL,
  `q38b_details` text,
  `q39_answer` varchar(10) DEFAULT NULL,
  `q39_details` text,
  `q40a_answer` varchar(10) DEFAULT NULL,
  `q40a_details` text,
  `q40b_answer` varchar(10) DEFAULT NULL,
  `q40b_details` text,
  `q40c_answer` varchar(10) DEFAULT NULL,
  `q40c_details` text,
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `pds_user_fk` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
