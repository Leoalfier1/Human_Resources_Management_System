...
router.get('/my-profile', verifyToken, ctrl.getMyProfile);
router.put('/my-profile', verifyToken, ctrl.updateMyProfile);
router.post('/request-update', verifyToken, ctrl.requestProfileUpdate);
