...
import AttendanceMonitor from './components/ld/attendance/AttendanceMonitor';

// --- L&D ADMIN PORTAL (new Figma design) ---
...
// --- L&D EMPLOYEE PORTAL (new Figma design) ---
  ...
  return (
    <Router>
      <Routes>
        ...
        {/* 4b-ii. L&D ADMIN PORTAL — new design (7 pages) */}
        <Route
          path="/ld-portal"
        ...
        {/* 4b-iii. L&D EMPLOYEE PORTAL — new design (7 pages) */}
        <Route
          path="/ld-employee"
